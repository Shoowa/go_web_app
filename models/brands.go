...
var BrandWhere = struct {
	...
	ID:   whereHelperint{field: "\"alpha\".\"brands\".\"id\""},
	Name: whereHelperstring{field: "\"alpha\".\"brands\".\"name\""},
}
...
var (
	brandAllColumns            = []string{"id", "name"}
	brandColumnsWithoutDefault = []string{"name"}
	brandColumnsWithDefault    = []string{"id"}
	brandPrimaryKeyColumns     = []string{"id"}
	brandGeneratedColumns      = []string{"id"}
)
...
// OneG returns a single brand record from the query using the global executor.
func (q brandQuery) OneG(ctx context.Context) (*Brand, error) {
...
// AllG returns all Brand records from the query using the global executor.
func (q brandQuery) AllG(ctx context.Context) (BrandSlice, error) {
...
// CountG returns the count of all Brand records in the query using the global executor
func (q brandQuery) CountG(ctx context.Context) (int64, error) {
...
func (q brandQuery) ExistsG(ctx context.Context) (bool, error) {
...
func Brands(mods ...qm.QueryMod) brandQuery {
	mods = append(mods, qm.From("\"alpha\".\"brands\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"alpha\".\"brands\".*"})
	}

	return brandQuery{q}
}

// FindBrandG retrieves a single record by ID.
func FindBrandG(ctx context.Context, iD int, selectCols ...string) (*Brand, error) {
	return FindBrand(ctx, boil.GetContextDB(), iD, selectCols...)
}

// FindBrand retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindBrand(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Brand, error) {
	brandObj := &Brand{}
	...
	query := fmt.Sprintf(
		"select %s from \"alpha\".\"brands\" where \"id\"=$1", sel,
	)
...
func (o *Brand) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *Brand) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		wl = strmangle.SetComplement(wl, brandGeneratedColumns)
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"alpha\".\"brands\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"alpha\".\"brands\" %sDEFAULT VALUES%s"
		}
...
// UpdateG a single Brand record using the global executor.
// See Update for more documentation.
func (o *Brand) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (o *Brand) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"alpha\".\"brands\" SET %s WHERE %s",
...
func (q brandQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o BrandSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o BrandSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"alpha\".\"brands\" SET %s WHERE %s",
...
func (o *Brand) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
func (o *Brand) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		insert = strmangle.SetComplement(insert, brandGeneratedColumns)
		update = strmangle.SetComplement(update, brandGeneratedColumns)
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"alpha\".\"brands\"", updateOnConflict, ret, update, conflict, insert)
...
// DeleteG deletes a single Brand record.
// DeleteG will match against the primary key column to find the record to delete.
func (o *Brand) DeleteG(ctx context.Context) (int64, error) {
...
func (o *Brand) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"alpha\".\"brands\" WHERE \"id\"=$1"
...
func (q brandQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o BrandSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o BrandSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"alpha\".\"brands\" WHERE " +
...
func (o *Brand) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: no Brand provided for reload")
	}
...
func (o *BrandSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("models: empty BrandSlice provided for reload all")
	}
...
func (o *BrandSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"alpha\".\"brands\".* FROM \"alpha\".\"brands\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, brandPrimaryKeyColumns, len(*o))
...
// BrandExistsG checks if the Brand row exists.
func BrandExistsG(ctx context.Context, iD int) (bool, error) {
	return BrandExists(ctx, boil.GetContextDB(), iD)
}

// BrandExists checks if the Brand row exists.
func BrandExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"alpha\".\"brands\" where \"id\"=$1 limit 1)"
